    ...
    <div className="relative w-full">
      ...
      {previewUrl && (
        <div className="relative mt-3">
          <div className="bg-primary relative size-20 overflow-hidden rounded-md border">
            <button
              type="button"
              onClick={handleClear}
              className="bg-destructive absolute top-1 right-1 ml-2 rounded-full p-0.5 text-sm"
