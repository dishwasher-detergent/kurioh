    ...
    if (segments[1] === "teams") {
      return (
        <>
          ...
          <Button
            asChild
            variant={segments[4] === "details" ? "secondary" : "ghost"}
            size="sm"
          >
            <Link href={`/app/teams/${segments[3]}/details`}>Details</Link>
          </Button>
          <Button
            asChild
          ...
          <Button
            asChild
            variant={segments[4] === "education" ? "secondary" : "ghost"}
            size="sm"
          >
            <Link href={`/app/teams/${segments[3]}/education`}>Education</Link>
          </Button>
          <Button
            asChild
